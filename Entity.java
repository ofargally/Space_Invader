...
public abstract class Entity {
   ...
   public boolean isCollidingWith(Entity other){
   	   if (this.getY() < other.getY() && (this.getY() + this.getHeight()) < other.getY())
   	   	   return false;
   	   else if (this.getY() > other.getY() && this.getY() > (other.getY() + other.getHeight()))
   	   	   return false;
   	   else if (this.getX() < other.getX() && this.getX() + this.getWidth() < other.getX())
   	   	   return false;
   	   else if (this.getX() > other.getX() && this.getX() > other.getX() + other.getWidth())
   	   	   return false;
   	   else
   	   	   return true;
   }
