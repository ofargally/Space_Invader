...
public class Avoid extends Entity implements Consumable, Scrollable {
    ...
    private static final String AVOID_IMAGE_FILE = "assets/Space/enemy.png";
    ...
    public int getPointsValue(){
       return 0;
       //throw new IllegalStateException("Hey you! You need to implement getPointsValue in Avoid.java!");
  }
